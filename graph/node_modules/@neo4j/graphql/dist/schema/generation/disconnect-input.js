...
function withDisconnectFieldInputType({ relationshipAdapter, composer, ifUnionMemberEntity, features, }) {
...
function makeDisconnectFieldInputTypeFields({ relationshipAdapter, composer, ifUnionMemberEntity, features, }) {
    const fields = {};
