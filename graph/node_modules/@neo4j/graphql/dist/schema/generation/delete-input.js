...
function makeDeleteInputType({ relationshipAdapter, composer, deprecatedDirectives, features, }) {
...
function withUnionDeleteInputType({ relationshipAdapter, composer, deprecatedDirectives, features, }) {
...
function makeUnionDeleteInputTypeFields({ relationshipAdapter, composer, deprecatedDirectives, features, }) {
    const fields = {};
    if (!(relationshipAdapter.target instanceof UnionEntityAdapter_1.UnionEntityAdapter)) {
...
function withDeleteFieldInputType({ relationshipAdapter, composer, ifUnionMemberEntity, features, }) {
...
function makeDeleteFieldInputTypeFields({ relationshipAdapter, composer, ifUnionMemberEntity, features, }) {
    const fields = {};
