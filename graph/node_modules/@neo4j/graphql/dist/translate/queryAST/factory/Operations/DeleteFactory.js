...
class DeleteFactory {
    ...
    parseDeleteArgs(args, isTopLevel) {
        let whereArg;
        const rawWhere = (0, utils_2.isRecord)(args.where) ? args.where : {};
        if (isTopLevel) {
        ...
        const deleteArg = (0, utils_2.isRecord)(args.delete) ? args.delete : {};
    ...
    createNestedDeleteOperations(deleteArg, source, context) {
        return (0, utils_2.filterTruthy)(Object.entries(deleteArg).flatMap(([key, valueArr]) => {
