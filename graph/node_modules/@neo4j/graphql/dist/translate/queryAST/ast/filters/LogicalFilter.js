        ...
        switch (this.operation) {
            case "NOT": {
                if (predicates.length === 0)
                    return undefined;
                const andPredicates = cypher_builder_1.default.and(...predicates);
                if (!andPredicates)
                    return undefined;
                return cypher_builder_1.default.not(andPredicates);
            }
            case "AND": {
            ...
            case "XOR": {
                return cypher_builder_1.default.xor(...predicates);
            }
        }
    }
}
